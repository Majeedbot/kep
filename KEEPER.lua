...
print("\27[0;35m>>"..[[
تم برمجة وكتابه السورس بواسطه المطور
القيصر كرار 
WRITING THE SOURCE BY : @LLX8XLL
CH SOURCE : @KEEPER_CH 
...
send(msg.chat_id_, msg.id_, 1,'🌀║ لا يوجد رد بهذا الاسم 📌',  1, "md")
else
